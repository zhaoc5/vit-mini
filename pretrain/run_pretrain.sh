...
python -m torch.distributed.launch --nproc_per_node=1 --use_env main.py \
    --batch-size 32 --warmup-epochs 5 --epochs 300 \
    --data-set IMNET --data-path /workspace/chongyang/data/ImageNet-1k \
    --teacher-model vit_large --target_model vit_tiny --model models_proteus_dinov2 \
    --patch_size 14 --mask_probability 0.5 --mask_ratio 0.5 --mask_first_n \
    --lambda_token 1.0 --lambda_fea 1.0 --lambda_patch 1.0 \
    --output_dir log/DINOv2_training-l_to_t-bs_32